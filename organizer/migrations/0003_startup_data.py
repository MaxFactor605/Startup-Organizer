# Generated by Django 3.1 on 2020-05-15 12:30
...
def add_startup_data(apps, scheme_editor):
    ...
    for startup in STARTUPS:
        startup_object = Startup.objects.create(
            name=startup['name'],
            slug=startup['slug'],
            email=startup['contact'],
            description=startup['description'],
            found_date=startup['founded_date'],
...
def remove_startup_data(apps, scheme_editor):
    Startup = apps.get_model('organizer', 'Startup')
    for startup in STARTUPS:
