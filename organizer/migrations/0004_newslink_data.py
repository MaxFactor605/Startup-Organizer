# Generated by Django 3.1 on 2020-05-15 13:05
...
def add_newslink_data(apps, scheme_editor):
...
def remove_newslink_data(apps, scheme_editor):
    Newslink = apps.get_model('organizer', 'NewsLink')
    Startup = apps.get_model('organizer', 'Startup')
    for newslink in NEWSLINKS:
